...
variable "github_webhook_ssm_parameter_name" {
  description = "Name of SSM parameter to keep webhook secret"
  type        = string
}

variable "github_atlantis_user_ssh_key_ssm_parameter_name" {
  description = "Name of SSM parameter to keep the ssh private secret"
  type        = string
  default     = "/atlantis/github/user/private_ssh_key"
}

variable "github_atlantis_user_token_ssm_parameter_name" {
  description = "Name of SSM parameter to keep github_atlantis_user_token"
  type        = string
  #tfsec:ignore:GEN001
...
variable "assume_role_arn" {
  description = "A list of the ARN to add as allowed assume role"
  type        = list(string)
  default = [
...
variable "github_repo_whitelist" {
